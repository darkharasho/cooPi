...
if __name__ == '__main__':
    ...
    while True:
        ...
        # CCW
        pwm.setServoPulse(config.DC_MOTOR_INA1, 0)  # set INA1 L
        pwm.setServoPulse(config.DC_MOTOR_INA2, 50000)  # set INA2 H
        print("M1 rotate")
        time.sleep(2)
        # CW
        pwm.setServoPulse(config.DC_MOTOR_INA1, 50000)  # set INA1 H
